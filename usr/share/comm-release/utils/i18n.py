#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Internationalization support for comm-release."""
...
app_dir = os.path.dirname(script_dir)  # comm-release/
...
# Configure the translation text domain for comm-release
gettext.bindtextdomain("comm-release", locale_dir)
gettext.textdomain("comm-release")
